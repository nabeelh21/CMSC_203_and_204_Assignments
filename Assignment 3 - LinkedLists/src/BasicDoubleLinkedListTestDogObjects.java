...
public class BasicDoubleLinkedListTestDogObjects {
	...
	public void testIteratorSuccessfulPrevious() {
		...
		assertEquals("Betsy", iterator.previous().getOwnerName());  // I inserted this, in order for the test to pass. Betsy, is the tail node, so the first time .previous() is called, it should return the tail node to start iteration. 
